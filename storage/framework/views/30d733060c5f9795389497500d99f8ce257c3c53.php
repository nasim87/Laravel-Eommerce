                                        ...
                                        <table class="table text-center">
                                            ...
                                            <tbody>    
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo e(asset('uploads/brands/'.$brand->image)); ?>" alt="Image" width="50" height="50"></td>
                                                    <td>
                                                        <form action="<?php echo e(route('brand.destroy', $brand->id )); ?>" method="POST">
                                                            ...
                                                            <a href="<?php echo e(route('brand.edit',$brand->id)); ?>" class="btn btn-info"> <i class="fa fa-pencil"></i></a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Nasim Amjad\bboron\resources\views/admin/partials/brand/brand.blade.php ENDPATH**/ ?>