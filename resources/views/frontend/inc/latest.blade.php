...
<div class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <!-- Product Single -->
            @foreach ($latestProducts as $latestPro )
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="product product-single">
                    <div class="product-thumb">
                        ...
                        <img src="{{ asset('uploads/products/'.$productImage[0])}}" widht="263" height="350"alt="{{$latestPro->name}}">
                    </div>
                    <div class="product-body">
                        <h3 class="product-price">$ {{$latestPro->price}}</h3>
                        ...
                        <h2 class="product-name"><a href="#">{{$latestPro->name}}</a></h2>
