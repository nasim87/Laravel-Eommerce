							...
							<table class="shopping-cart-table table">
								...
								<tbody>
                                    @foreach (Cart::content() as $item )
                                        ...
                                        @endphp
									<tr>
										<td class="thumb"><img src="{{asset('uploads/products/'.$product_images[0])}}" alt=""></td>
										<td class="details">
										...
										<td class="price text-center"><strong>BDT {{$item->model->price}}</strong><br><del class="font-weak"><small>$40.00</small></del></td>
										<td class="qty text-center"><input class="input" type="number" value="{{$item->qty}}"></td>
                                        <td class="total text-center"><strong class="primary-color">BDT {{$item->subtotal()}}</strong></td>
                                        <td class="text-right">
                                        <form action="{{route('checkout.destroy',$item->rowId)}}" method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
								...
								<tfoot>
									<tr>
										...
										<th>SUBTOTAL</th>
										<th colspan="2" class="sub-total">BDT {{Cart::subtotal()}}</th>
									</tr>
									<tr>
										<th class="empty" colspan="3"></th>
										<th>SHIPING</th>
									...
									<tr>
										<th class="empty" colspan="3"></th>
										<th>TOTAL</th>
										<th colspan="2" class="total">BDT {{Cart::total()}}</th>
									</tr>
								</tfoot>
							</table>
