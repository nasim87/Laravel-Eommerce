                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                          <div class="col">
                                            ...
                                            <input type="text" name="quantity" value="{{old('quantity')}}" class="form-control" placeholder="Product Qty">
                                          </div>
                                          <div class="col">
                                      ...
                                      <div class="row">
                                          <div class="col">
                                            ...
                                            <input type="text" name="r_price" value="{{old('r_price')}}" class="form-control" placeholder="Regualr Price">
                                          </div>
                                          <div class="col">
                                      ...
                                      <div class="row">
                                          <div class="col">
                                            ...
                                            <textarea name="description" value="{{old('description')}}" id="summernote"></textarea>
                                          </div>
                                      </div> &nbsp;
                                      <div class="row">
                                          <div class="col">
                                            <label>Product Specification</label>
                                            <textarea name="specification" value="{{old('specification')}}" id="summernote2"></textarea>
                                          </div>
                                      </div> &nbsp;
                                      <div class="row">
                                        <div class="col-6">
