    ...
    <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.html"><img src="{{asset('assets/admin/assets/images/icon/logo.png')}}" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                    ...
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="{{route('brand.create')}}">Create New Brand</a></li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="{{route('product.sold')}}">Sold Products</a></li>
                                </ul>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <ul class="collapse">
                                    <li><a href="{{route('banner.create')}}">Banner</a></li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="{{route('order.confirm')}}">Approved Orders</a></li>
